...
export const ACTION_NAMES = ["filter_area","filter_attribute","drop_empty","rename_field","transform_crs","fix_encoding","simplify","field_calculate","validate_geometry","buffer","clip","intersect","dissolve","export","noop","need_clarification"];
